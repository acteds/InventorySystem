...
<center>
    <div class="message">
        <form name="form1" action="InventorySubChange" method="post" onsubmit="return NotNull();">
            <table width="317">
                <tr><td colspan="2" class="title">修改货品出库清单</td></tr>
                ...
                <tr>
                    ...
                    <td><input name="quantity2" type="number" min="0" max="${list.get("quantity")}" value="${list2.get("quantity")}"></td>
                </tr>
                <tr>
                    <td align="right">出库说明:</td>
                    <td><textarea style="width: 166px;" name="explanation2">${list2.get("explanation")}</textarea></td>
                </tr>
                <tr>
                    <td align="right">创建时间:</td>
                    <td><c:set scope="page" var="createTime" value="createTime"/>
                        <input name="createTime2" type="text" class="underline-border" style="width: 167px;"
                               value="<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${list2.get(createTime)}"/>" readonly="readonly">
                    </td>
                </tr>
                <tr>
